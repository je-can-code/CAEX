...
/*:
 * @plugindesc (v2.2) Activates movement poses in the character.
 * @author Moghunter
 *
 * @param Poses for Followers
 * @desc Activate poses in followers
 * @default true
 *
 * @param Dash Pose
 * @desc Activate dash pose.
 * @default true
 *
 * @param Jump Pose
 * @desc Activate jump pose.
 * @default true
 *
 * @param Idle Pose
 * @desc Activate hold pose.
 * @default true
 *
 * @param Idle Start Time
 * @desc Time to activate the holding pose.
 * @default 60
 *
 * @help  
 * =============================================================================
 ...
 * =============================================================================
 * Activates movement poses in the character. (Idle / Dash / Jump)
 *
 * =============================================================================
 * IMAGES
 * ============================================================================= 
 * Save the images to the folder /img/characters/
 * The images of the poses should be recorded as follows.
 *
 * (IDLE POSE)
 * FILE_NAME + _IDLE.png
 *
 ...
 * MULTIFRAMES
 * ============================================================================= 
 * To activate multiple frames in the character image, simply name the character 
 * image as follows
 *
 *
 ...
 * ANIMATION SPEED
 * ============================================================================= 
 * This function allows you to adjust the speed of the animation.
 *
 ...
 * ============================================================================= 
 * This function allows you to adjust the X and Y position of the character image.
 *
 ...
 * =============================================================================
 *
 * - To activate the poses during the game use the command plugin below.
 *
 * enable_charposes
 * 
 * -  To disable the poses during the game use the command plugin below.
 * 
 * disable_charposes
 *
 * =============================================================================
